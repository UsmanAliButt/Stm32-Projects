...
When the user presses the User-button, DMA transfers the selected waveform to DAC.

For each press on User button, One signal has been selected and monitored on the DAC Channel1
...
@par Directory contents 
  ...
  - DAC_SignalsGeneration/stm32f0xx_conf.h    Library Configuration file
  - DAC_SignalsGeneration/stm32f0xx_it.c      Interrupt handlers
  - DAC_SignalsGeneration/stm32f0xx_it.h      Interrupt handlers header file
  - DAC_SignalsGeneration/main.c              Main program
  - DAC_SignalsGeneration/system_stm32f0xx.c  STM32F0xx system source file
...
@par Hardware and Software environment
  ...
  - STM32F0-Discovery Set-up
     - Use User-button connected to PA0.
