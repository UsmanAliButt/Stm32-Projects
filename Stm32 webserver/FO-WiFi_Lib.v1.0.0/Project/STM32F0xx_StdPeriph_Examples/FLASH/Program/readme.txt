...
@par Directory contents 
  ...
  - FLASH/Program/stm32f0xx_conf.h    Library Configuration file
  - FLASH/Program/stm32f0xx_it.c      Interrupt handlers
  - FLASH/Program/stm32f0xx_it.h      Interrupt handlers header file
  - FLASH/Program/main.c              Main program
  - FLASH/Program/system_stm32f0xx.c  STM32F0xx system source file
...
@note Known limitation:
       When running this example in debug mode with TrueSTUDIO or MDK-ARM toolchains,
       the connection with the debugger is lost. The problem does not occur when
